    ...
    export default {
        ...
        methods: {
            ...
            judgeTimeValue(time){
                ...
                switch(time){
                    case 0:
                        data = this.valueTimeStart0
                        break;
                    case 1:
                        data = this.valueTimeStart1
                        break;
                }
                ...
                let newM = new Date().getMonth()+1
                if(Y>newY){
                    alert('请选择正确时间，终止时间<=当前时间')
                    switch(time){
                        case 0:
                             this.valueTimeStart0 = newY + '-' + newM;
                            break;
                        case 1:
                             this.valueTimeStart1 = newY + '-' + newM;
                            break;
                    }
                    return;
                }else{
